...
/*
 ...
 Modified by @dreherd
 - added half-duplex support for SP3485C or (not tested) max485
...
@ingroup setup
*/
ModbusMaster232::ModbusMaster232(uint8_t u8MBSlave, int dere_pin = DERE_PIN)
{
  _u8SerialPort = 0;
